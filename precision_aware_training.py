...
if __name__ == "__main__":
    ...
    parser.add_argument('--distribution_weight', type=float, default=10.0, help='Weight for Beta distribution loss')
    parser.add_argument('--precision_weight', type=float, default=0.1, help='Weight for mean precision loss')
    parser.add_argument('--adversary_weight', type=float, default=0.1, help='Weight for adversarial loss')
